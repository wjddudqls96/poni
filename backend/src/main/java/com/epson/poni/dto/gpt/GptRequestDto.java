...
public class GptRequestDto {
    ...
    public static GptRequestDto createDefault(String sentence) {
        List<Message> messages = Arrays.asList(
                new Message("user", "{\"sentence\": \"사슴이 이쁘다.\", \"speak\": \"[sa-su-mi i-ppeu-da]\", \"analysis\": [{\"word\": \"사슴\", \"grammar\": \"주어\", \"word_description\": \"동물의 종류 중 하나로, 대개 크고 가늘며 뿔이 있는 동물을 일컫는다.\", \"synonyms\": [\"deer\"]}, {\"word\": \"이쁘다\", \"grammar\": \"동사\", \"word_description\": \"외모나 모습이 아름답고 매력적이라는 뜻을 나타내는 동사이다.\", \"synonyms\": [\"beautiful\", \"pretty\", \"lovely\"]}]}"),
    ...
    public static GptRequestDto translateSentence(String sentence) {
        List<Message> messages = Arrays.asList(
                new Message("user", "{\"sentence\": \"Hello, how are you?\",  \"translatedSentence\": \"안녕하세요, 어떻게 지내세요?\", \"pronunciation\": \"annyeonghaseyo, eotteoke jinaeseyo?\""),
